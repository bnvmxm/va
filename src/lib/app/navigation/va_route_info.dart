...
abstract class VARouteInfo {
  ...
  const factory VARouteInfo.editPhraseGroup(String groupId) = VARouteEditPhraseGroup;
  const factory VARouteInfo.exercise(String groupId) = VARouteExercise;
  const factory VARouteInfo.phraseGroup(String groupId) = VARoutePhraseGroup;
  const factory VARouteInfo.addPhrase(String groupId) = VARouteAddPhrase;
  const factory VARouteInfo.editPhrase(String groupId, String phraseUid) = VARouteEditPhrase;
