...
extension VAThemeIdExt on VAThemeId {
  ColorScheme getColorScheme() =>
      this == VAThemeId.darkCold ? ColorScheme.dark() : ColorScheme.light();

  Brightness getBrightness() => this == VAThemeId.darkCold ? Brightness.dark : Brightness.light;

  ColorScheme getMaterialColorScheme() => getColorScheme().copyWith(
  ...
  MaterialColor getMaterialColorSwatch() =>
      MaterialColor(_specs[this]!.colorPrimary500.value, <int, Color>{
  ...
  ThemeData getMaterialThemeData() {
    ...
    return ThemeData(
        ...
        textSelectionTheme: TextSelectionThemeData(
            cursorColor: _specs[this]!.colorAccentVariant,
            selectionHandleColor: _specs[this]!.colorAccentVariant),
