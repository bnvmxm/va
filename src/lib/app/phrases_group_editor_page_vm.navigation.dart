part of 'phrases_group_editor_page_vm.dart';

Route<PhraseGroupEditorPageResult> routePhraseGroupEditorPage({String initialGroupName}) =>
    MaterialPageRoute<PhraseGroupEditorPageResult>(
        builder: (context) => PhraseGroupEditorPage(initialGroupName: initialGroupName),
...
extension on PhraseGroupEditorPageVM {
